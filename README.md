...
3. **Chartreuse and Safety Orange are pops, not floods.** One CTA per page goes a long way. The old chartreuse-highlighter underline is deemphasized — use at most a single-word hairline accent, and only when it earns its place.
